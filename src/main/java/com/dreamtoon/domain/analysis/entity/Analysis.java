...
public class Analysis {
    ...
    @Builder
    public Analysis(Dream dream, Integer healthScore, Map<EmotionType, Double> emotions,
                    Integer tensionLevel, Integer controlLevel, Boolean isNightmare,
                    List<String> repeatingSymbols, List<String> relationshipPatterns,
                    Boolean hasResolution, String aiInsight) {
        this.dream = dream;
        ...
        this.relationshipPatterns = relationshipPatterns != null ? relationshipPatterns : new ArrayList<>();
