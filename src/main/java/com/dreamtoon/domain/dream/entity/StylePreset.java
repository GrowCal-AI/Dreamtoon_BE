...
public enum StylePreset {
    ...
    DARK_FANTASY("다크 판타지", "Webtoon style, dark fantasy setting, dramatic lighting, intense atmosphere"),
    ...
    COMEDY("코미디", "Webtoon style, humorous and lighthearted, exaggerated expressions, bright colors"),
