...
public class VoiceTranscriptionService {
        ...
        public TranscriptionResponse transcribeAudio(MultipartFile audioFile) {
                ...
                try {
                        log.info(
                                        "Starting audio transcription for file: {} (size: {} bytes)",
                        ...
                        ResponseEntity<String> response =
                                        restTemplate.exchange(
                                                        WHISPER_API_URL, HttpMethod.POST, requestEntity, String.class);
                        ...
                        log.info(
                                        "Audio transcription completed in {}ms: {} characters",
                                        processingTime,
